/*! vitepress-theme-teek v1.5.4 */
import DefaultTheme, { VPBadge } from 'vitepress/theme';
import * as Vue from 'vue';
import { getCurrentScope, onScopeDispose, computed, toValue, watch, shallowRef, getCurrentInstance, onMounted, nextTick, reactive, ref, readonly, inject, isRef, watchEffect, provide, unref, onUpdated, onUnmounted, defineComponent, resolveComponent, createElementBlock, openBlock, normalizeClass, Fragment, renderList, createElementVNode, createBlock, createCommentVNode, toDisplayString, createVNode, renderSlot, useId, createPropsRestProxy, useSlots, toRaw, normalizeStyle, resolveDynamicComponent, onBeforeUnmount, effectScope, Teleport, Transition, withCtx, withModifiers, createTextVNode, withDirectives, vShow, useModel, mergeProps, render, mergeModels, vModelText, shallowReactive, mergeDefaults, isVNode, withKeys, h, onBeforeMount, vModelRadio, toHandlers, createApp, defineAsyncComponent, normalizeProps, guardReactiveProps, TransitionGroup, createStaticVNode, createSlots, markRaw, vModelDynamic } from 'vue';
import { useData, useRouter, getScrollOffset, onContentUpdated, useRoute, withBase as withBase$1 } from 'vitepress';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        "ul",
        {
          class: normalizeClass([unref(ns).b(), __props.root ? unref(ns).is("root") : unref(ns).is("nested")])
        },
        [
            ...
            renderList(__props.headers, ({ children, link, title }) => {
              return openBlock(), createElementBlock("li", { key: link }, [
                createElementVNode("a", {
                  class: normalizeClass(unref(ns).m("link")),
                  href: link,
                  onClick,
                  title
                }, toDisplayString(title), 11, _hoisted_1$11),
                children?.length ? (openBlock(), createBlock(_component_DocAsideOutlineItem, {
                  key: 0,
                  headers: children
...
var _sfc_main$1x = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("i", { innerHTML: __props.icon }, null, 8, _hoisted_1$10);
    };
  }
});
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return __props.iconType === "unicode" ? (openBlock(), createElementBlock(
        ...
        2
        /* CLASS */
      )) : __props.iconType === "symbol" ? (openBlock(), createElementBlock("svg", _hoisted_2$N, [
...
var _sfc_main$1t = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const finalIcon = computed(() => {
      if (!isString$1(__props.icon)) return toRaw(__props.icon);
    ...
    const isSvgIcon = computed(() => isString$1(__props.icon) && (__props.iconType === "svg" || __props.icon.startsWith("svg-") || isString$1(__props.icon)));
    const isSvgIconHtml = computed(() => isString$1(__props.icon) && __props.icon?.includes("<svg"));
    const isFontIcon = computed(() => isString$1(__props.icon) && fontIconType.value);
    ...
    const isIconifyOffline = computed(() => !isString$1(__props.icon) && (__props.iconType === "iconifyOffline" || "body" in __props.icon));
    const isIconifyOnline = computed(() => isString$1(__props.icon) && (__props.iconType === "iconifyOnline" || __props.icon.includes(":")));
      ...
      return !isFontIcon.value && !isImage.value && !isSvgIconHtml.value ? (openBlock(), createElementBlock(
        ...
        [
          unref(slot).default ? renderSlot(_ctx.$slots, "default", { key: 0 }) : isComponent.value ? (openBlock(), createBlock(resolveDynamicComponent(finalIcon.value), {
            key: 1,
            size: __props.size
          }, null, 8, ["size"])) : isIconifyOffline.value ? (openBlock(), createBlock(_sfc_main$1v, {
            key: 2,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isIconifyOnline.value ? (openBlock(), createBlock(_sfc_main$1u, {
            key: 3,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isSvgIcon.value ? (openBlock(), createBlock(_sfc_main$1x, {
            key: 4,
            icon: finalIcon.value
        ...
        class: normalizeClass([unref(ns).b(), unref(ns).is("hover", __props.hover)]),
        style: normalizeStyle(getStyle())
      }, null, 14, _hoisted_1$_)) : isFontIcon.value && fontIconType.value ? (openBlock(), createBlock(_sfc_main$1w, {
        key: 2,
        icon: finalIcon.value,
        ...
        class: normalizeClass([unref(ns).b(), unref(ns).is("hover", __props.hover)]),
        style: normalizeStyle(getStyle())
      }, null, 14, _hoisted_2$M)) : createCommentVNode("v-if", true);
    };
  }
});
      ...
      return openBlock(), createElementBlock(
        ...
        [
          (__props.src || __props.srcSet) && !hasLoadError.value ? (openBlock(), createElementBlock("img", {
            ...
            onError: handleError
          }, null, 44, _hoisted_1$Z)) : __props.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
            key: 1,
            icon: __props.icon
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "breadcrumb",
        ref: breadcrumb,
        class: normalizeClass(unref(ns$2).b()),
        role: "navigation",
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "span",
        {
          class: normalizeClass(unref(ns$2).e("item"))
        },
        [
          createElementVNode(
            "span",
            {
              ref: "link",
              class: normalizeClass(unref(ns$2).e("inner")),
              role: "link"
            },
            [
              renderSlot(_ctx.$slots, "default")
          ...
          createElementVNode(
            "span",
            {
              class: normalizeClass(unref(ns$2).e("separator")),
              role: "presentation"
            },
            toDisplayString(unref(breadcrumbContext)?.separator),
            3
            /* TEXT, CLASS */
          )
        ],
                ...
                createVNode(unref(TkFocusTrap), {
                  ...
                  default: withCtx(() => [
                    ...
                    createElementVNode(
                      ...
                      [
                        createVNode(unref(_sfc_main$1t), { icon: unref(closeIcon) }, null, 8, ["icon"])
                      ],
                      2
                      /* CLASS */
                    ),
                    ...
                    !isSingle.value ? (openBlock(), createElementBlock(
                      ...
                      [
                        createElementVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1t), { icon: unref(arrowLeftIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        ),
                        createElementVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1t), { icon: unref(arrowRightIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        )
...
const createImageViewer = (options) => {
  ...
  instance = createVNode(_sfc_main$1n, options);
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          withDirectives(createElementVNode("div", {
            ...
            iconComponent.value ? (openBlock(), createBlock(unref(_sfc_main$1t), {
              key: 1,
            ...
            __props.showClose ? (openBlock(), createBlock(unref(_sfc_main$1t), {
              key: 2,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        __props.prevText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : __props.prevIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
          key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        __props.nextText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : __props.nextIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
          key: 1,
...
const _hoisted_2$H = ["disabled", "aria-label"];
...
const _hoisted_2$G = ["tabindex", "aria-label"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          }, " 1 ", 10, _hoisted_1$Q)) : createCommentVNode("v-if", true),
          showPrevMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_3$w)) : (openBlock(), createElementBlock("span", {
              key: 1,
              innerHTML: unref(moreFilledIcon)
            }, null, 8, _hoisted_4$s))
          ], 42, _hoisted_2$G)) : createCommentVNode("v-if", true),
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(pagers.value, (pager) => {
              return openBlock(), createElementBlock("li", {
                ...
                tabindex: tabindex.value
              }, toDisplayString(pager), 11, _hoisted_5$i);
            }),
            128
            /* KEYED_FRAGMENT */
          )),
          ...
          ], 42, _hoisted_6$e)) : createCommentVNode("v-if", true),
          __props.pageCount > 1 ? (openBlock(), createElementBlock("li", {
            ...
            tabindex: tabindex.value
          }, toDisplayString(__props.pageCount), 11, _hoisted_9$5)) : createCommentVNode("v-if", true)
        ],
        34
...
var _sfc_main$1f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const componentMap = computed(() => ({
      ...
      jumper: h(_sfc_main$1i, {
        size: props.size
      }),
      pager: h(_sfc_main$1g, {
        currentPage: currentPageModel.value,
      ...
      total: h(_sfc_main$1h, { total: isAbsent(props.total) ? 0 : props.total })
    }));
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
...
const _hoisted_2$F = ["value", "name", "disabled", "checked", "aria-checked"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        ...
        createElementVNode(
          ...
          [
            __props.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
              key: 0,
              icon: __props.icon,
              "aria-hidden": "true"
            }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.text || _ctx.$slots.default ? (openBlock(), createElementBlock(
        ...
        {
          key: 0,
          class: normalizeClass([unref(ns).b(), __props.type && unref(ns).m(__props.type), __props.position && unref(ns).m(__props.position), __props.size && unref(ns).m(__props.size)])
        },
        [
          renderSlot(_ctx.$slots, "default", {}, () => [
            createTextVNode(
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasTitle.value || hasText.value ? (openBlock(), createElementBlock(
        ...
        {
          key: 0,
          class: normalizeClass([unref(ns).b(), "vp-doc"])
        },
        [
          createElementVNode(
            "div",
            ...
            [
              hasTitle.value ? (openBlock(), createElementBlock("div", _hoisted_1$O, [
                renderSlot(_ctx.$slots, "title", {}, () => [
                  createElementVNode("span", { innerHTML: __props.title }, null, 8, _hoisted_2$E)
                ])
              ])) : createCommentVNode("v-if", true),
              hasText.value ? (openBlock(), createElementBlock("p", _hoisted_3$u, [
                renderSlot(_ctx.$slots, "default", {}, () => [
                  createElementVNode("span", { innerHTML: __props.text }, null, 8, _hoisted_4$r)
                ])
              ])) : createCommentVNode("v-if", true)
            ],
            2
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        __props.post.frontmatter.titleTag && __props.titleTagProps?.position === "left" ? (openBlock(), createBlock(unref(_sfc_main$1b), mergeProps({
          key: 0,
        ...
        __props.post.frontmatter.titleTag && __props.titleTagProps?.position === "right" ? (openBlock(), createBlock(unref(_sfc_main$1b), mergeProps({
          key: 1,
          text: __props.post.frontmatter.titleTag
        }, __props.titleTagProps, {
          "aria-label": __props.post.frontmatter.titleTag
...
var _sfc_main$16 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(_sfc_main$1y), {
        class: normalizeClass(unref(ns).b()),
                                    ...
                                    (openBlock(true), createElementBlock(
                                      ...
                                      renderList(p, (item) => {
                                        return openBlock(), createElementBlock("li", {
                                          ...
                                          createElementVNode("a", {
                                            href: item.url && unref(withBase$1)(item.url),
            ...
            return openBlock(), createElementBlock(
              ...
              [
                item.show && (item.data || item.dataList?.length) ? (openBlock(), createElementBlock("span", {
                  ...
                  unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                    key: 0,
                    icon: item.icon,
                  ...
                  item.data ? (openBlock(), createElementBlock("a", {
                    key: 1,
                    title: item.title,
                    href: item.href && unref(withBase$1)(item.href),
                    target: item.target,
                    class: normalizeClass([item.class, "hover-color"]),
                    "aria-label": item.data
                  }, toDisplayString(item.data), 11, _hoisted_3$s)) : (openBlock(true), createElementBlock(
                    Fragment,
                    { key: 2 },
                    renderList(item.dataList, (data, index) => {
                      return openBlock(), createElementBlock("a", {
                        key: index,
                        title: item.title,
                        href: item.href && unref(withBase$1)(item.href.replace("{data}", encodeURIComponent(data))),
                        class: normalizeClass([item.class, "hover-color"]),
                        "aria-label": data
                      }, toDisplayString(data), 11, _hoisted_4$p);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.breadcrumb ? (openBlock(), createBlock(unref(_sfc_main$15), { key: 0 })) : createCommentVNode("v-if", true),
        isShowInfo.value ? (openBlock(), createElementBlock(
          ...
          [
            ...
            unref(docAnalysisConfig).wordCount && pageViewInfo.value.wordCount ? (openBlock(), createElementBlock("div", _hoisted_2$z, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.wordCount), 9, _hoisted_3$r)
            ])) : createCommentVNode("v-if", true),
            unref(docAnalysisConfig).readingTime && pageViewInfo.value.readingTime ? (openBlock(), createElementBlock("div", _hoisted_4$o, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.readingTime), 9, _hoisted_5$g)
            ])) : createCommentVNode("v-if", true),
            usePageView.value ? (openBlock(), createElementBlock("div", _hoisted_6$c, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                key: 0,
                icon: unref(viewIcon)
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
              ...
              }, toDisplayString(unref(isGet) ? unref(pagePv) : "Get..."), 9, _hoisted_7$7)
            ])) : createCommentVNode("v-if", true)
          ],
          2
          /* CLASS */
...
var _sfc_main$11 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(ns).b(), unref(ns).m("doc-after")]),
        "aria-label": unref(t)("tk.articleAppreciation.label")
      }, [
        docAfterOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
          ...
          "aria-controls": `${unref(ns).e("content")}`
        }, null, 8, _hoisted_2$x)) : docAfterOptions.value.expandTitle || docAfterOptions.value.collapseTitle ? (openBlock(), createElementBlock("button", {
          key: 1,
          ...
          icon.value ? (openBlock(), createBlock(unref(_sfc_main$1t), {
            key: 0,
            class: normalizeClass(unref(ns).e("button__icon")),
            icon: icon.value,
            size: 16,
            "aria-hidden": "true"
          ...
          }, null, 8, _hoisted_4$n)) : (openBlock(), createElementBlock("span", {
            key: 2,
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            ...
            ], 10, _hoisted_6$b)) : createCommentVNode("v-if", true)
          ]),
          _: 1
          /* STABLE */
        }, 8, ["name"])
        ...
        createVNode(unref(_sfc_main$1e), {
          ...
          reference: withCtx(() => [
            docAfterPopperOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
              ...
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns).e("content")}`
            }, null, 8, _hoisted_2$w)) : docAfterPopperOptions.value.title ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: normalizeClass(unref(ns).e("button")),
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns).e("content")}`,
              ...
              }, null, 8, _hoisted_4$m)) : createCommentVNode("v-if", true)
            ], 10, _hoisted_3$o)) : createCommentVNode("v-if", true)
          ]),
          default: withCtx(() => [
            createElementVNode("div", {
              class: normalizeClass([unref(ns).e("content"), unref(ns).m("doc-after-popper")]),
              "aria-label": unref(t)("tk.articleAppreciation.contentLabel")
            }, [
              createElementVNode("div", {
                class: normalizeClass(unref(ns).e("content")),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(_sfc_main$1y), {
        ...
        default: withCtx(() => [
          unref(frontmatter).title ? (openBlock(), createElementBlock("h1", _hoisted_1$F, [
            createTextVNode(
            ...
            renderList(enhancedCategories.value, (item) => {
              return openBlock(), createElementBlock(
                ...
                [
                  ...
                  }, toDisplayString(item.name) + " " + toDisplayString(unref(t)("tk.articleOverview.category")), 9, _hoisted_5$d),
                  createElementVNode("table", _hoisted_6$9, [
                        ...
                        renderList(item.data, (data) => {
                          return openBlock(), createElementBlock("tr", {
                            ...
                            createElementVNode("td", null, [
                              createElementVNode("a", {
                                href: data.url && unref(withBase$1)(data.url),
      ...
      return openBlock(), createElementBlock(
        ...
        [
          createElementVNode("button", {
            ...
            !unref(copied) ? (openBlock(), createElementBlock("div", _hoisted_2$u, [
              createVNode(unref(_sfc_main$1t), {
          ...
          createElementVNode(
            ...
            [
              ...
              unref(archivesPath) ? (openBlock(), createElementBlock("a", {
                key: 0,
                href: unref(withBase$1)(unref(archivesPath)),
                class: "hover-color",
                "aria-label": unref(t)("tk.articleUpdate.label")
              }, toDisplayString(unref(t)("tk.articleUpdate.label")), 9, _hoisted_1$D)) : (openBlock(), createElementBlock(
                "span",
                _hoisted_2$t,
                  ...
                  createElementVNode(
                    ...
                    [
                      item.url ? (openBlock(), createElementBlock("a", {
                        key: 0,
                        href: unref(withBase$1)(item.url),
...
var _sfc_main$V = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const dataArray = computed(() => {
      ...
      return [isFunction(imgSrc) ? imgSrc() : imgSrc || []].flat().map((item) => item && withBase$1(item));
    });
    const {
      data: imageSrc,
      start,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          unref(bodyBgImgConfig).mask ? (openBlock(), createElementBlock("div", _hoisted_1$C)) : createCommentVNode("v-if", true)
        ],
        6
        /* CLASS, STYLE */
      );
      ...
      return openBlock(), createElementBlock(
        ...
        [
          !__props.item.children ? (openBlock(), createElementBlock("a", {
            key: 0,
            href: __props.item.url && unref(withBase$1)(__props.item.url),
            ...
            __props.item.frontmatter?.titleTag ? (openBlock(), createBlock(unref(_sfc_main$1b), {
              key: 0,
          ...
          ], 8, _hoisted_1$B)) : __props.item.children.length ? (openBlock(), createElementBlock(
            Fragment,
            { key: 1 },
            [
              createElementVNode("div", {
                ...
                }, toDisplayString(`${__props.index}. ${__props.item.title}`), 9, _hoisted_5$c)
              ], 10, _hoisted_3$k),
              ...
              ], 10, _hoisted_6$8)) : createCommentVNode("v-if", true)
            ],
            64
            /* STABLE_FRAGMENT */
          )) : createCommentVNode("v-if", true)
...
const createOverlay = (onClick) => {
  ...
  const app = createApp(_sfc_main$S, { onClick }).mount(container);
  return app.$el;
};
      ...
      return openBlock(), createElementBlock(
        ...
        [
          unref(cssLink) ? (openBlock(), createElementBlock("link", {
            ...
            crossorigin: "anonymous"
          }, null, 8, _hoisted_1$x)) : createCommentVNode("v-if", true),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          }, null, 10, _hoisted_1$w)) : createCommentVNode("v-if", true),
            ...
            [
              ...
              createElementVNode(
                ...
                [
                  ...
                  unref(playgroundUrl) ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                    key: 0,
                  ...
                  unref(githubUrl) ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                    key: 1,
              ...
              createVNode(Transition, {
                ...
                default: withCtx(() => [
                  withDirectives(createElementVNode(
                    ...
                    [
                      createVNode(unref(_sfc_main$1t), { icon: unref(caretTopIcon) }, null, 8, ["icon"]),
                      createElementVNode(
                        "span",
                        null,
      ...
      return unref(footerGroupConfig).length ? (openBlock(), createElementBlock(
        ...
        [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(unref(footerGroupConfig), (group, index) => {
              return openBlock(), createElementBlock("div", {
                ...
                createElementVNode(
                  "div",
                  {
                    class: normalizeClass([unref(ns).e("title"), "flx-center"])
                  },
                  [
                    group.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                      key: 0,
                      icon: group.icon,
                      style: { "margin-right": "4px" },
                      "aria-hidden": "true"
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(group.links || [], (link, idx) => {
                      return openBlock(), createElementBlock(
                        ...
                        {
                          key: (link.name || "") + idx,
                          class: normalizeClass([unref(ns).e("link")])
                        },
                        [
                          link.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                            key: 0,
                            icon: link.icon,
                            style: { "margin-right": "4px" },
                            "aria-hidden": "true"
                          ...
                          createElementVNode("a", {
                            ...
                            unref(isExternal)(link.link || "") ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                              key: 0,
                              icon: unref(externalLinkIcon),
                              class: normalizeClass(unref(ns).e("link__external-icon")),
                              "aria-hidden": "true"
                            }, null, 8, ["icon", "class"])) : createCommentVNode("v-if", true)
                          ], 8, _hoisted_1$v)
                        ],
        ...
        unref(social).length ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(social), (item, index) => {
              return openBlock(), createElementBlock("a", {
                key: index,
                href: item.link && unref(withBase$1)(item.link),
                title: item.name,
                target: "_blank",
                "aria-label": item.name
              }, [
                item.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                  key: 0,
        ...
        unref(footerInfo) ? (openBlock(), createElementBlock(
          ...
          [
            ...
            createElementVNode("div", {
                  ...
                  return openBlock(), createElementBlock(
                    ...
                    [
                      ...
                      item.link ? (openBlock(), createElementBlock("a", {
                        key: 1,
                        href: unref(withBase$1)(item.link),
                        target: "_blank",
                        "aria-label": item.name
                      }, toDisplayString(item.name), 9, _hoisted_7$4)) : (openBlock(), createElementBlock(
                        "span",
                        _hoisted_8$4,
                        toDisplayString(item.name),
                        1
              ...
              }, null, 8, _hoisted_9$4)) : createCommentVNode("v-if", true)
            ], 10, _hoisted_6$7),
            (openBlock(true), createElementBlock(
              Fragment,
              null,
...
var _sfc_main$I = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const postUrl = __props.post.url && withBase$1(__props.post.url);
    ...
    const coverImgMap = computed(() => {
      ...
      return {
        default: {
          is: "div",
          props: {
            style: `background-image: url(${withBase$1(imgSrc)});`
          }
        },
        full: {
          is: "img",
          props: {
            src: withBase$1(imgSrc)
          }
        }
      };
    });
          ...
          createElementVNode("div", _hoisted_2$n, [
            createElementVNode(
              ...
              [
                ...
                excerpt.value && unref(postConfig).excerptPosition === "top" ? (openBlock(), createElementBlock("div", {
                  ...
                  }, toDisplayString(unref(postConfig).moreLabel), 9, _hoisted_6$6)) : createCommentVNode("v-if", true)
                ], 10, _hoisted_4$h)) : createCommentVNode("v-if", true),
                createCommentVNode(" \u6587\u7AE0\u4FE1\u606F "),
                createElementVNode("div", {
                  class: normalizeClass(unref(ns).e("left__footer")),
                  "aria-label": unref(t)("tk.homePost.infoLabel")
                }, [
                  isShowInfo.value ? (openBlock(), createBlock(unref(_sfc_main$14), {
                    key: 0,
                    post: __props.post,
                    scope: "post",
                ...
                excerpt.value && unref(postConfig).excerptPosition === "bottom" ? (openBlock(), createElementBlock("div", {
                  ...
                  unref(postConfig).showMore ? (openBlock(), createElementBlock("a", {
                    ...
                    href: unref(postUrl),
                    "aria-label": unref(postConfig).moreLabel
                  }, toDisplayString(unref(postConfig).moreLabel), 9, _hoisted_10$1)) : createCommentVNode("v-if", true)
                ], 10, _hoisted_8$3)) : createCommentVNode("v-if", true)
              ],
              2
              /* CLASS */
            ),
            ...
            createElementVNode(
              ...
              [
                ...
                ], 10, _hoisted_11$1)) : createCommentVNode("v-if", true)
              ],
              2
              /* CLASS */
            )
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          !!__props.post.frontmatter.sticky ? (openBlock(), createBlock(unref(_sfc_main$1t), {
            key: 0,
            icon: unref(topIcon),
            class: "top",
            size: 40,
            ...
            [
              createElementVNode("a", {
                ...
                createElementVNode("img", {
                  src: unref(withBase$1)(imgSrcList.value[0]),
                  class: "cover-img"
                }, null, 8, _hoisted_2$m)
              ], 8, _hoisted_1$s)
            ],
          ...
          createElementVNode(
            ...
            [
              ...
              excerpt.value ? (openBlock(), createElementBlock("span", {
                ...
                innerHTML: excerpt.value,
                "aria-label": unref(t)("tk.homePost.excerptLabel")
              }, null, 8, _hoisted_4$g)) : createCommentVNode("v-if", true),
              isShowInfo.value ? (openBlock(), createBlock(unref(_sfc_main$14), {
                key: 1,
                post: __props.post,
                scope: "post",
          ...
          currentPosts.value ? (openBlock(), createElementBlock(
            ...
            [
                        ...
                        return openBlock(), createElementBlock(
                          ...
                          [
                            unref(windowTransition) ? (openBlock(), createElementBlock(
                              ...
                              [
                                unref(postConfig).postStyle === "card" ? (openBlock(), createBlock(_sfc_main$H, {
                                  key: 0,
                                  post
                                }, null, 8, ["post"])) : (openBlock(), createBlock(_sfc_main$I, {
                                  key: 1,
                                  post,
              ...
              createElementVNode("div", {
                ...
                totalPostsCount.value >= pageSize.value ? (openBlock(), createBlock(unref(_sfc_main$1f), mergeProps({
                  key: 0,
      ...
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.$slots["teek-home-banner-name"] ? renderSlot(_ctx.$slots, "teek-home-banner-name", normalizeProps(mergeProps({ key: 0 }, { name: unref(bannerConfig).name }))) : (openBlock(), createElementBlock(
          ...
          [
            ...
            }, toDisplayString(unref(bannerConfig).name), 11, _hoisted_2$j)
          ],
          2112
        ...
        createElementVNode("p", {
          ...
          isDefaultDescStyle.value ? (openBlock(), createElementBlock(
            ...
            default: withCtx(() => [
              ...
              }, toDisplayString(unref(text) || descArray.value[0]), 9, _hoisted_5$8))
            ]),
            _: 1
            /* STABLE */
            ...
            [
              ...
              }, toDisplayString(unref(typesText)), 9, _hoisted_6$5),
              createElementVNode(
                "span",
                {
...
var _sfc_main$C = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return features.value.length ? (openBlock(), createBlock(TransitionGroup, {
        key: 0,
        name: unref(ns).join("slide-next"),
        tag: "div",
        class: normalizeClass([unref(ns).b(), unref(ns).join("wallpaper-outside"), "flx-wrap-between"]),
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(bannerConfig).features, (feature, index) => {
              return withDirectives((openBlock(), createElementBlock("div", {
                ...
                (openBlock(), createBlock(resolveDynamicComponent(feature.link ? "a" : "div"), {
                  href: unref(withBase$1)(feature.link ?? ""),
                  class: "flx-column-center hover-color",
                  "aria-label": feature.title
                }, {
                  default: withCtx(() => [
                    feature.image ? (openBlock(), createElementBlock("img", {
                      key: 0,
                      class: "feature-img",
                      src: unref(withBase$1)(feature.image),
                      alt: feature.title,
                      "aria-label": feature.title
                    }, null, 8, _hoisted_2$i)) : createCommentVNode("v-if", true),
                    createElementVNode("p", {
                      id: `feature-title-${index}`,
                      class: "feature-title"
                    }, toDisplayString(feature.title), 9, _hoisted_3$e),
                    createElementVNode(
                      "p",
                      _hoisted_4$e,
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          createElementVNode("div", {
            ...
            unref(bannerConfig).imgWaves && currentBgStyle.value.isBannerFullImgBgStyle && !currentBgStyle.value.isBodyImgBgStyle ? (openBlock(), createBlock(_sfc_main$B, {
              key: 0,
          ...
          [
            renderSlot(_ctx.$slots, "title", {}, () => [
              __props.titleLink ? (openBlock(), createElementBlock("a", {
                key: 0,
                href: unref(withBase$1)(__props.titleLink),
              ...
              ], 8, _hoisted_2$h)) : __props.titleClick ? (openBlock(), createElementBlock("a", {
                key: 1,
              ...
              ], 10, _hoisted_4$d)) : (openBlock(), createElementBlock("span", {
                key: 2,
                class: "title flx-align-center",
                innerHTML: __props.title
              }, null, 8, _hoisted_6$4))
            ...
            renderSlot(_ctx.$slots, "page", normalizeProps(guardReactiveProps({ pagination })), () => [
              __props.page ? (openBlock(), createElementBlock("div", _hoisted_7$2, [
...
var _sfc_main$y = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const avatarBgStyle = computed(() => ({ backgroundImage: `url(${withBase$1(bloggerConfig.value.circleBgImg)})` }));
    ...
    return (_ctx, _cache) => {
      return unref(bloggerConfig).name ? (openBlock(), createBlock(unref(_sfc_main$z), {
        key: 0,
        ...
        default: withCtx(() => [
          ...
          createElementVNode(
            ...
            [
              createElementVNode("div", null, [
                unref(bloggerConfig).avatar ? (openBlock(), createBlock(unref(_sfc_main$1s), {
                  key: 0,
                  src: unref(withBase$1)(unref(bloggerConfig).avatar),
                  ...
                  "aria-hidden": "true"
                }, null, 8, ["src", "size", "shape", "alt", "title"])) : (openBlock(), createBlock(unref(_sfc_main$1s), {
                  key: 1,
                ...
                unref(bloggerConfig).status?.icon && shape.value?.startsWith("circle") ? (openBlock(), createBlock(unref(_sfc_main$1s), {
                  key: 2,
          ...
          ], 10, _hoisted_1$k)) : createCommentVNode("v-if", true),
          createElementVNode("div", {
            ...
            createElementVNode(
              ...
              [
                createElementVNode(
                  "div",
                  {
                    class: normalizeClass(unref(ns).e("avatar"))
                  },
                  [
                    unref(blogger).avatar ? (openBlock(), createElementBlock("img", {
                      key: 0,
                      src: unref(withBase$1)(unref(blogger).avatar),
                      alt: unref(t)("tk.myCard.avatarAlt")
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$z), {
        ...
        default: withCtx(({ transitionName }) => [
          ...
          }, toDisplayString(unref(topArticleConfig).emptyLabel), 11, _hoisted_4$a))
        ]),
        _: 1
        /* STABLE */
...
var _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleSwitchCategory = (category = "") => {
      ...
      const categoriesPathConst = withBase$1(categoryPath.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$z), {
        ...
        default: withCtx(({ transitionName }) => [
          categories.value.length ? (openBlock(), createBlock(TransitionGroup, {
            ...
            default: withCtx(() => [
              ...
              !__props.categoriesPage && unref(categoryConfig).limit < categories.value.length ? (openBlock(), createElementBlock("a", {
                key: 0,
                href: unref(withBase$1)(unref(categoryPath)),
                "aria-label": unref(categoryConfig).moreLabel
              }, toDisplayString(unref(categoryConfig).moreLabel), 9, _hoisted_3$9)) : createCommentVNode("v-if", true)
            ]),
            _: 1
            /* STABLE */
          }, 8, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(unref(categoryConfig).emptyLabel), 11, _hoisted_4$9))
        ]),
        _: 1
        /* STABLE */
...
var _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleSwitchTag = (tag = "") => {
      const { pathname, searchParams } = new URL(window.location.href);
      const categoriesPageLinkConst = withBase$1(tagPath.value);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$z), {
        ...
        default: withCtx(({ transitionName }) => [
          tags.value.length ? (openBlock(), createBlock(TransitionGroup, {
            ...
            default: withCtx(() => [
              ...
              !__props.tagsPage && unref(tagConfig).limit < tags.value.length ? (openBlock(), createElementBlock("a", {
                key: 0,
                href: unref(withBase$1)(unref(tagPath)),
                class: "more",
                "aria-label": unref(tagConfig).moreLabel
              }, toDisplayString(unref(tagConfig).moreLabel), 9, _hoisted_3$8)) : createCommentVNode("v-if", true)
            ]),
            _: 1
            /* STABLE */
          }, 8, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
          ...
          }, toDisplayString(unref(tagConfig).emptyLabel), 11, _hoisted_4$8))
        ]),
        _: 1
        /* STABLE */
      }, 8, ["page", "modelValue", "pageSize", "total", "title", "autoPage", "pageSpeed", "class", "aria-label"]);
...
var _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("a", {
        href: __props.item.link && unref(withBase$1)(__props.item.link),
        target: "_blank",
        class: "hover-color flx-align-center",
        ...
        createElementVNode("div", _hoisted_2$b, [
          createElementVNode("img", {
            src: __props.item.avatar && unref(withBase$1)(__props.item.avatar),
            class: "avatar",
        ...
        createElementVNode(
          ...
          [
            ...
            }, toDisplayString(__props.item.name), 9, _hoisted_4$7),
            createElementVNode("div", {
              class: "friend-desc sle",
              title: __props.item.desc
            }, toDisplayString(__props.item.desc), 9, _hoisted_5$5)
          ],
          2
          /* CLASS */
        )
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$z), {
        ...
        default: withCtx(({ transitionName, startAutoPage, closeAutoPage }) => [
          ...
          }, toDisplayString(unref(friendLinkConfig).emptyLabel), 11, _hoisted_1$e))
        ]),
        _: 1
        /* STABLE */
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(isHomePage) && (unref(teekConfig).banner.enabled ?? true) ? withDirectives((openBlock(), createElementBlock(
          ...
          _hoisted_2$9,
          [
            createVNode(unref(_sfc_main$A), { disabled: isPaging.value }, createSlots({
              _: 2
              /* DYNAMIC */
            }, [
              renderList(_ctx.$slots, (_, name) => {
        ...
        unref(teekConfig).wallpaper.enabled && (unref(teekConfig).banner.bgStyle === "fullImg" || unref(teekConfig).bodyBgImg.imgSrc) ? (openBlock(), createBlock(unref(_sfc_main$J), { key: 1 })) : createCommentVNode("v-if", true)
      ], 10, _hoisted_1$c);
    };
  }
});
...
var _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(featuresConfig)?.length ? (openBlock(), createElementBlock(
        "div",
        {
          key: 0,
          class: normalizeClass([unref(ns).b(), "vp-doc"])
        ...
        [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(unref(featuresConfig), (feature) => {
              return openBlock(), createElementBlock(
                Fragment,
                {
                  key: feature.title
                ...
                [
                  feature.features ? (openBlock(), createElementBlock(
                    "div",
                    {
                      key: 0,
                      class: normalizeClass([unref(ns).e("feature-wrapper"), "features-wrapper"])
                    },
                    [
                      createElementVNode(
                        "div",
                        {
                          class: normalizeClass(unref(ns).e("feature__content"))
                        },
                        [
                          createElementVNode("img", {
                            src: feature.image,
                          ...
                          createElementVNode(
                            "div",
                            {
                              class: normalizeClass([unref(ns).e("feature__header"), "header"])
                            },
                            [
                              createElementVNode("h2", {
                                ref_for: true,
                              ...
                              }, null, 8, _hoisted_3$5)) : createCommentVNode("v-if", true)
                            ],
                            2
                            /* CLASS */
                          ),
                          feature.features?.length ? (openBlock(), createElementBlock("div", _hoisted_4$5, [
                            (openBlock(true), createElementBlock(
                              Fragment,
                              null,
                              renderList(feature.features, (item) => {
                                return openBlock(), createBlock(resolveDynamicComponent(item.link ? "a" : "div"), {
                                  key: item.title,
                                  href: unref(withBase$1)(item.link ?? ""),
                                  ...
                                  default: withCtx(() => [
                                    ...
                                    item.details ? (openBlock(), createElementBlock("p", {
                                      key: 0,
                                      ref_for: true,
                                      ref_key: "textInstance",
                                      ref: textInstance,
                    ...
                    2
                    /* CLASS */
                  )) : feature.highlights ? (openBlock(), createElementBlock(
                    "div",
                    {
                      key: 1,
                      class: normalizeClass([unref(ns).e("highlight-wrapper"), "features-wrapper"])
                    },
                    [
                      createElementVNode(
                        "div",
                        {
                          class: normalizeClass(unref(ns).e("highlight"))
                        },
                        [
                          createElementVNode("img", {
                            src: feature.image,
                          ...
                          createElementVNode(
                            "div",
                            {
                              class: normalizeClass(unref(ns).e("highlight__content"))
                            },
                            [
                              createElementVNode(
                                "div",
                                {
                                  class: normalizeClass([unref(ns).e("highlight__header"), "header"])
                                },
                                [
                                  createElementVNode("h2", {
                                    ref_for: true,
                              ...
                              feature.highlights?.length ? (openBlock(), createElementBlock("div", _hoisted_10, [
                                (openBlock(true), createElementBlock(
                                  Fragment,
                                  null,
                                  renderList(feature.highlights, (item) => {
                                    return openBlock(), createBlock(resolveDynamicComponent(item.link ? "a" : "div"), {
                                      key: item.title,
                                      href: unref(withBase$1)(item.link ?? ""),
                                      class: normalizeClass([{ "no-details": !item.details }, "highlights__item item"])
                                    }, {
                                      default: withCtx(() => [
                                        createElementVNode(
                                          "h3",
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns$1).e("title"), unref(ns$1).is("disabled", !!__props.disabled)])
        },
        [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(_sfc_main$1e), {
        class: normalizeClass(unref(ns$1).e("helper")),
        ...
        default: withCtx(() => [
          createElementVNode(
            "div",
            {
              class: normalizeClass(unref(ns$1).e("helper__popup"))
            },
            [
              renderSlot(_ctx.$slots, "default")
            ],
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns).b(), unref(ns).is("active", Boolean(__props.active))])
        },
        [
          renderSlot(_ctx.$slots, "default")
        ],
      ...
      return openBlock(), createElementBlock("div", null, [
        createElementVNode(
          ...
          [
            ...
            __props.helper ? (openBlock(), createBlock(_sfc_main$m, {
              key: 0,
              ...
              default: withCtx(() => [
                createElementVNode(
                  "div",
                  {
                    class: normalizeClass(unref(ns$1).e("helper__body"))
                  },
                  [
                    createElementVNode(
                      "h4",
                      {
                        class: normalizeClass(unref(ns$1).em("helper", "title"))
                      },
                      [
                    ...
                    createElementVNode(
                      "p",
                      {
                        class: normalizeClass(unref(ns$1).em("helper", "desc"))
                      },
                      [
                    ...
                    (openBlock(true), createElementBlock(
                      Fragment,
                      null,
                      renderList(__props.tips, (tip, index) => {
                        return openBlock(), createElementBlock(
                          "div",
                          {
                            key: index,
                            class: normalizeClass(unref(ns$1).e("helper__body__tip"))
                          },
                          [
                            createElementVNode("div", _hoisted_1$9, [
                              tip.icon ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                                key: 0,
                                icon: tip.icon,
                                size: 16,
                                style: { "margin-right": "4px" }
        ...
        __props.borderHighlight ? (openBlock(), createBlock(_sfc_main$l, {
          key: 0,
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["active"])) : (openBlock(), createElementBlock("div", _hoisted_4$4, [
          renderSlot(_ctx.$slots, "default")
        ]))
      ]);
    };
          ...
          withDirectives(createVNode(_sfc_main$k, {
            ...
            default: withCtx(() => [
              createVNode(unref(_sfc_main$1m), {
                ...
                max: max.value,
                format,
                class: normalizeClass(unref(ns$1).e("slide")),
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          withDirectives(createVNode(_sfc_main$k, {
            ...
            helper: !unref(themeEnhanceConfig).layoutSwitch?.disableDocMaxWidthHelp,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "span",
        {
          class: normalizeClass([unref(ns$1).e("switch"), unref(ns$1).is("checked", check.value)]),
          onClick: handleClick
        },
        [..._cache[0] || (_cache[0] = [
          createElementVNode(
...
var _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$k, {
        class: normalizeClass(unref(ns$1).e("theme-color")),
            ...
            renderList(unref(themeColorSelectList), (item) => {
              return openBlock(), createElementBlock(
                ...
                [
                  ...
                  }, toDisplayString(item.label), 9, _hoisted_4$3),
                      ...
                      renderList(item.options, (option) => {
                        return openBlock(), createElementBlock("li", {
                          ...
                          createElementVNode(
                            "div",
                            {
                              class: normalizeClass(["color-wrapper flx-center", unref(ns$1).is("active", option.value === unref(themeColorName))])
                            },
                            [
                              createElementVNode(
                                "div",
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        props.enabled && !shouldRecalculate.value ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            class: normalizeClass([
              unref(ns$1).join("spotlight-hover"),
              unref(spotlightStyle) === unref(SpotlightStyle).Under ? unref(ns$1).join("spotlight-hover__under") : "",
              unref(spotlightStyle) === unref(SpotlightStyle).Aside ? unref(ns$1).join("spotlight-hover__aside") : ""
            ]),
            "aria-hidden": "true",
            focusable: "false"
          },
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          unref(spotlight) && !unref(supportTouch) ? (openBlock(), createBlock(_sfc_main$e, {
            key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: unref(transitionName) }, {
        default: withCtx(() => [
          unref(spotlightToggledOn) ? (openBlock(), createBlock(_sfc_main$k, {
            key: 0,
            icon: unref(clickIcon),
...
var _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !unref(isMobile) && unref(themeEnhanceConfig).position === "top" ? (openBlock(), createBlock(unref(_sfc_main$1e), {
        key: 0,
        class: normalizeClass([unref(ns$1).b(), "flx-align-center"]),
        "popper-class": unref(ns$1).e("popover"),
        "y-offset": -15
      }, {
        reference: withCtx(() => [
          createVNode(unref(_sfc_main$1t), {
        ...
        default: withCtx(() => [
          createElementVNode(
            "div",
            {
              class: normalizeClass(unref(ns$1).e("content"))
            },
            [
              ...
              !disabledList.value.themeColor ? (openBlock(), createBlock(_sfc_main$f, { key: 1 })) : createCommentVNode("v-if", true),
          ...
          renderSlot(_ctx.$slots, "default", {
            ...
            withDirectives(createElementVNode("div", {
              ...
              unref(backTopConfig).content === "progress" ? (openBlock(), createElementBlock(
                ...
                1
                /* TEXT */
              )) : unref(backTopConfig).content === "icon" ? (openBlock(), createBlock(unref(_sfc_main$1t), {
                key: 1,
                icon: unref(rocketIcon),
                "aria-hidden": "true"
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true)
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          unref(backTopConfig).enabled ? (openBlock(), createBlock(_sfc_main$a, { key: 0 }, {
          ...
          unref(toCommentConfig).enabled && (commentConfig.value.enabled || commentConfig.value.provider) ? (openBlock(), createBlock(_sfc_main$9, { key: 1 }, {
            default: withCtx((scope) => [
          ...
          !disabledThemeColor.value ? (openBlock(), createBlock(_sfc_main$8, { key: 2 })) : createCommentVNode("v-if", true),
        ...
        createElementVNode(
          ...
          [
            unref(frontmatter).leftImg ? (openBlock(), createElementBlock(
              ...
              [
                createElementVNode("img", {
                  src: unref(withBase$1)(unref(frontmatter).leftImg),
                  alt: "login"
                }, null, 8, _hoisted_2$2)
              ],
              2
            ...
            createElementVNode(
              ...
              [
                ...
                createElementVNode("form", _hoisted_5$1, [
                  (openBlock(true), createElementBlock(
                    Fragment,
                    null,
                  ...
                  createElementVNode(
                    ...
                    [
                      createElementVNode("button", {
                        ...
                        createVNode(unref(_sfc_main$1t), { icon: unref(refreshRightIcon) }, null, 8, ["icon"]),
                        createElementVNode(
                          "span",
                          null,
                      ...
                      createElementVNode("button", {
                        ...
                        createVNode(unref(_sfc_main$1t), { icon: unref(successFilledIcon) }, null, 8, ["icon"]),
                        createElementVNode(
                          "span",
                          null,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          targetLink.value ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
            createElementVNode(
              "button",
              {
                class: "btn",
                    ...
                    createElementVNode(
                      ...
                      [
                        ...
                        createElementVNode(
                          "p",
                          null,
                          toDisplayString(unref(isString$1)(unref(loadingConfig)) ? unref(loadingConfig) : "Teek \u62FC\u547D\u52A0\u8F7D\u4E2D ..."),
                          1
                          /* TEXT */
                        )
                      ],
            ...
            [
              ...
              createElementVNode(
                ...
                [
                  ...
                  !unref(isMobile) ? (openBlock(), createBlock(unref(_sfc_main$15), { key: 0 })) : createCommentVNode("v-if", true),
                  createElementVNode(
                    "div",
                    {
                      ...
                      unref(frontmatter).categories && unref(articleBannerConfig).showCategory ? (openBlock(), createElementBlock("div", _hoisted_2, [
                        (openBlock(true), createElementBlock(
                          ...
                          renderList(unref(frontmatter).categories, (category) => {
                            return openBlock(), createElementBlock("a", {
                              key: category,
                              href: unref(withBase$1)(`/categories?category=${category}`),
                      ...
                      unref(frontmatter).tags && unref(articleBannerConfig).showTag ? (openBlock(), createElementBlock("div", _hoisted_4, [
                        (openBlock(true), createElementBlock(
                          ...
                          renderList(unref(frontmatter).tags, (tag) => {
                            return openBlock(), createElementBlock("a", {
                              key: tag,
                              href: unref(withBase$1)(`/tags?tag=${tag}`),
                              class: "meta-info tag",
                              title: tag
                            }, [
                              _cache[0] || (_cache[0] = createElementVNode(
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const commentConfig = computed(() => {
      ...
      if (isBoolean$1(frontmatterComment)) {
    ...
    return (_ctx, _cache) => {
      return unref(teekConfig).teekTheme ? (openBlock(), createElementBlock(
        ...
        { key: 0 },
        [
          unref(teekConfig).loading ?? false ? (openBlock(), createBlock(unref(_sfc_main$2), {
            key: 0,
          ...
          unref(frontmatter).layout !== false ? (openBlock(), createElementBlock(
            ...
            { key: 3 },
            [
              unref(teekConfig).bodyBgImg?.imgSrc ? (openBlock(), createBlock(unref(_sfc_main$V), { key: 0 })) : createCommentVNode("v-if", true),
          ...
          withDirectives(createVNode(unref(Layout), {
            ...
            "doc-before": withCtx(() => [
              ...
              unref(teekConfig).codeBlock.enabled ?? true ? (openBlock(), createBlock(unref(_sfc_main$R), { key: 1 })) : createCommentVNode("v-if", true),
              topTipConfig.value ? (openBlock(), createBlock(
                unref(_sfc_main$18),
                normalizeProps(mergeProps({ key: 2 }, unref(isBoolean$1)(topTipConfig.value) ? {} : topTipConfig.value)),
                null,
                16
                /* FULL_PROPS */
              )) : createCommentVNode("v-if", true),
              unref(teekConfig).sidebarTrigger ? (openBlock(), createBlock(unref(_sfc_main$3), { key: 3 }, {
                default: withCtx((scope) => [
            ...
            "doc-footer-before": withCtx(() => [
              ...
              bottomTipConfig.value ? (openBlock(), createElementBlock(
                ...
                [
                  ...
                  createVNode(
                    unref(_sfc_main$18),
                    normalizeProps(guardReactiveProps(unref(isBoolean$1)(bottomTipConfig.value) ? {} : bottomTipConfig.value)),
                    null,
                    16
                    /* FULL_PROPS */
                  ),
            ...
            "doc-after": withCtx(() => [
              ...
              ["doc-after", "doc-after-popper"].includes(unref(teekConfig).appreciation.position) ? (openBlock(), createElementBlock(
                ...
                [
                  ...
                  unref(teekConfig).appreciation.position === "doc-after" ? (openBlock(), createBlock(unref(_sfc_main$11), { key: 0 })) : unref(teekConfig).appreciation.position === "doc-after-popper" ? (openBlock(), createBlock(unref(_sfc_main$10), { key: 1 })) : createCommentVNode("v-if", true),
              ...
              unref(isArchivesPage) || unref(isCataloguePage) || unref(isArticleOverviewPage) ? (openBlock(), createElementBlock(
                ...
                [
                  ...
                  unref(isArchivesPage) ? (openBlock(), createBlock(
                    ...
                    1024
                    /* DYNAMIC_SLOTS */
                  )) : unref(isArticleOverviewPage) ? (openBlock(), createBlock(unref(_sfc_main$Z), { key: 2 })) : createCommentVNode("v-if", true),
...
export { LayoutMode, SpotlightStyle, StorageSerializers, TeekConfigProvider, ThemeColorName, _sfc_main$16 as TkArchivesPage, _sfc_main$13 as TkArticleAnalyze, _sfc_main$15 as TkArticleBreadcrumb, _sfc_main$$ as TkArticleHeadingHighlight, _sfc_main$_ as TkArticleImagePreview, _sfc_main$14 as TkArticleInfo, _sfc_main$Z as TkArticleOverviewPage, _sfc_main$1y as TkArticlePage, _sfc_main$Y as TkArticlePageStyle, _sfc_main$X as TkArticleShare, _sfc_main$17 as TkArticleTitle, _sfc_main$W as TkArticleUpdate, _sfc_main$12 as TkAsideBottomAppreciation, _sfc_main$1s as TkAvatar, _sfc_main$V as TkBodyBgImage, _sfc_main$1r as TkBreadcrumb, _sfc_main$1q as TkBreadcrumbItem, _sfc_main$U as TkCatalogueItem, _sfc_main$T as TkCataloguePage, _sfc_main$R as TkCodeBlockToggle, _sfc_main$Q as TkCommentArtalk, _sfc_main$P as TkCommentGiscus, _sfc_main$O as TkCommentTwikoo, _sfc_main$N as TkCommentWaline, _sfc_main$M as TkDemoCode, _sfc_main$11 as TkDocAfterAppreciation, _sfc_main$10 as TkDocAfterAppreciationPopper, _sfc_main$1z as TkDocAsideOutline, TkFocusTrap, _sfc_main$L as TkFooterGroup, _sfc_main$K as TkFooterInfo, _sfc_main$p as TkHome, _sfc_main$A as TkHomeBanner, _sfc_main$E as TkHomeBannerBgImage, _sfc_main$F as TkHomeBannerBgPure, _sfc_main$D as TkHomeBannerContent, _sfc_main$C as TkHomeBannerFeature, _sfc_main$B as TkHomeBannerWaves, _sfc_main$q as TkHomeCardList, _sfc_main$v as TkHomeCategoryCard, _sfc_main$r as TkHomeDocAnalysisCard, _sfc_main$o as TkHomeFeature, _sfc_main$s as TkHomeFriendLinkCard, _sfc_main$J as TkHomeFullscreenWallpaper, _sfc_main$y as TkHomeMyCard, _sfc_main$x as TkHomeMyCardScreen, _sfc_main$I as TkHomePostItem, _sfc_main$G as TkHomePostList, _sfc_main$u as TkHomeTagCard, _sfc_main$w as TkHomeTopArticleCard, _sfc_main$1t as TkIcon, _sfc_main$1n as TkImageViewer, _sfc_main$1m as TkInputSlide, _sfc_main as TkLayout, _sfc_main$5 as TkLoginPage, message as TkMessage, _sfc_main$6 as TkNotice, _sfc_main$z as TkPageCard, _sfc_main$1f as TkPagination, _sfc_main$1e as TkPopover, _sfc_main$7 as TkRightBottomButton, _sfc_main$4 as TkRiskLinkPage, _sfc_main$2 as TkRouteLoading, _sfc_main$1c as TkSegmented, _sfc_main$1d as TkSegmentedItem, _sfc_main$3 as TkSidebarTrigger, _sfc_main$g as TkSwitch, _sfc_main$b as TkThemeEnhance, _sfc_main$k as TkThemeEnhanceBaseTemplate, _sfc_main$1b as TkTitleTag, _sfc_main$1a as TkTransitionCollapse, _sfc_main$19 as TkVerifyCode, _sfc_main$18 as TkVpContainer, WhatsApp, Z_INDEX_INJECTION_KEY, activateMaxWidthSlideMedia, addUnit, aliPayIcon, alignLeftIcon, alignTextLeftIcon, arrowDownIcon, arrowLeftIcon, arrowRightIcon, artalkContext, autoWidthIcon, baiduAnalytics, bilibili, calendarIcon, callBusuanzi, callVercount, caretTopIcon, categoryIcon, circleCloseFilledIcon, clickIcon, clockIcon, closeIcon, codeIcon, collectionTagIcon, commentIcon, copyIcon, copyrightIcon, createCardContainer, createCardContainers, createContainerThenGet, createContainerThenUse, createContainersThenGet, createContainersThenUse, createDynamicComponent, createImageViewer, createScript, dArrowLeftIcon, dArrowRightIcon, index as default, defaultInitialZIndex, defaultPrivateConfig, docAnalysisIcon, docMaxWidthSlideStorageKey, docMaxWidthVar, editPenIcon, email, emptyIcon, en, externalLinkIcon, folderOpenedIcon, formatDate, formatDiffDate, formatDiffDateToDay, friendLinkIcon, fullScreenOneIcon, fullscreenIcon, fullscreenTwoIcon, get, getDarkColor, getInstance, getLastOffset, getLightColor, getLoginStorageKey, getNowDate, getOffsetOrSpace, giscusContext, gitee, github, githubIcon, googleAnalytics, guessSerializerType, hexToRgb, houseIcon, icpRecordIcon, inBrowser, infoFilledIcon, instances, is, isArray$1 as isArray, isAsyncFunction, isBoolean$1 as isBoolean, isClient, isDate, isDef, isElement, isEmpty, isExternal, isFocusable, isFunction, isImageDom, isImagePath, isIos, isNull$1 as isNull, isNullAndUnDef, isNullOrUnDef, isNumber, isObject$2 as isObject, isPhone, isPlainFunction, isPromise, isServer, isString$1 as isString, isStringNumber, isType, isUnDef, isValidURL, layoutIcon, layoutModeAttribute, layoutModeStorageKey, localeContextKey, lockIcon, loginUrlKeyMap, magicIcon, mobileMaxWidthMedia, moblieQQ, moreFilledIcon, music, noticeIcon, ns$1 as ns, onClickOutside, overallReductionIcon, pageMaxWidthSlideStorageKey, pageMaxWidthVar, pageNumKey, playgroundIcon, postDataUpdateSymbol, postsContext, questionFilledIcon, readingIcon, refreshLeftIcon, refreshRightIcon, removeStorageItem, removeUnit, rgbToHex, rocketIcon, scaleIcon, scaleToOriginalIcon, shareIcon, size as sizeIcon, spotlightStorageKey, spotlightStyleStorageKey, successFilledIcon, tagIcon, teekConfigContext, telegram, themeBgColorStorageKey, themeColorAttribute, themeColorList, themeColorStorageKey, themeIcon, thumbsIcon, topArticleIcon, topIcon, touchMedia, trackPageview, transitionName, twikooContext, umamiAnalytics, upperFirst, useAllPosts, useAnchorScroll, useClipboard, useCommon, useCopyBanner, useDebounce, useElementHover, useEventListener, useIntersectionObserver, useLocale, useMediaQuery, useMounted, useNamespace, usePagePath, usePageState, usePopoverSize, usePosts, useRiskLink, useScopeDispose, useScrollData, useSidebar, useStorage, useSwitchData, useTagColor, useTeekConfig, useTextTypes, useThemeColor, useThemeColorList, useUvPv, useViewTransition, useVpRouter, useWatchLogin, useWindowSize, useWindowTransition, useWindowTransitionConfig, useZIndex, userIcon, varNameList, verifyModeMap, version, viewIcon, walineContext, warningFilledIcon, waterIcon, weChatPayIcon, withBase, zIndexContextKey, zhCn, zoomInIcon, zoomOutIcon };
